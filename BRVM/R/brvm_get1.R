...
#' data_tbl
#'
#' BRVM_get1("ALL INDEXES",from = Sys.Date()-252*3,to = Sys.Date())#Three year ago to now
#'
...
#'
#' BRVM_get1(c("BRVM10","BRVMAG"),Period = 5,from = "2021-01-04", to = "2022-01-04") #Get weekly data
#'
